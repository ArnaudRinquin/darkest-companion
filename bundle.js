...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_root2.default, { store: _store2.default }), document.getElementById('app-root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _locationSelector = __webpack_require__(179);
	
	var _locationSelector2 = _interopRequireDefault(_locationSelector);
	
	var _lengthSelector = __webpack_require__(187);
	
	var _lengthSelector2 = _interopRequireDefault(_lengthSelector);
	
	var _missionProvisions = __webpack_require__(188);
	
	var _missionProvisions2 = _interopRequireDefault(_missionProvisions);
	
	var _locationCurios = __webpack_require__(190);
	
	var _locationCurios2 = _interopRequireDefault(_locationCurios);
	
	var _locationTips = __webpack_require__(192);
	
	var _locationTips2 = _interopRequireDefault(_locationTips);
	...
	function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'selectorsAndProvisions' },
	      _react2.default.createElement(
	        'div',
	        { className: 'selectors' },
	        _react2.default.createElement(_locationSelector2.default, null),
	        _react2.default.createElement(_lengthSelector2.default, null)
	      ),
	      _react2.default.createElement(_missionProvisions2.default, null),
	      _react2.default.createElement(_locationTips2.default, null)
	    ),
	    _react2.default.createElement(_locationCurios2.default, null),
	    _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement(
	        'a',
	        { href: 'http://www.darkestdungeon.com/the-team/' },
	        'Red Hook Studios'
	      ),
	      ', creators of the (awesome) ',
	      _react2.default.createElement(
	        'a',
	        { href: 'http://www.darkestdungeon.com/' },
	        'Darkest Dungeon'
	      ),
	      ' game.'
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _torchRadioGroup = __webpack_require__(180);
	
	var _mission = __webpack_require__(184);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function LocationSelector(_ref) {
	  var selectedLocation = _ref.selectedLocation;
	  var selectLocation = _ref.selectLocation;
	
	  return _react2.default.createElement(
	    'section',
	    { className: 'location-selector centered' },
	    _react2.default.createElement(
	      'h1',
	      null,
	      'Location'
	    ),
	    _react2.default.createElement(_torchRadioGroup.TorchRadioGroup, { options: _mission.LOCATIONS, selectedValue: selectedLocation, onChange: selectLocation, name: 'location' })
	  );
	}
	
	exports.default = (0, _reactRedux.connect)(_mission.getSelectedLocation, { selectLocation: _mission.selectLocation })(LocationSelector);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TorchRadioGroup = TorchRadioGroup;
	
	var _react = __webpack_require__(2);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _reactRadioGroup = __webpack_require__(181);
	...
	var renderOption = function renderOption(Radio, option) {
	  return _react2.default.createElement(
	    'label',
	    { className: 'torch-radio', key: 'option-' + option, htmlFor: option },
	    _react2.default.createElement(Radio, { id: option, value: option }),
	    _react2.default.createElement('i', { className: 'torch-radio-icon' }),
	    _react2.default.createElement(
	      'div',
	      { className: 'torch-radio-label' },
	      _react2.default.createElement(_capitalize2.default, { text: option })
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getSelectedLocationAndLength = exports.getSelectedLength = exports.getSelectedLocation = exports.getMission = exports.LENGTHS = exports.LOCATIONS = undefined;
	
	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
	
	exports.selectLocation = selectLocation;
	exports.selectLength = selectLength;
	exports.default = missionReducer;
	...
	var LOCATIONS = exports.LOCATIONS = ['ruins', 'warrens', 'weald', 'cove'];
	
	var LENGTHS = exports.LENGTHS = ['short', 'medium', 'long'];
	...
	var getMission = exports.getMission = (0, _reselect.createSelector)(_.selector, function (_ref2) {
	  var mission = _ref2.mission;
	  return mission;
	});
	
	var getSelectedLocation = exports.getSelectedLocation = (0, _reselect.createSelector)(getMission, function (_ref3) {
	  var selectedLocation = _ref3.selectedLocation;
	  return { selectedLocation: selectedLocation };
	});
	
	var getSelectedLength = exports.getSelectedLength = (0, _reselect.createSelector)(getMission, function (_ref4) {
	  var selectedLength = _ref4.selectedLength;
	  return { selectedLength: selectedLength };
	});
	
	var getSelectedLocationAndLength = exports.getSelectedLocationAndLength = (0, _reselect.createSelector)(getSelectedLocation, getSelectedLength, function (_ref5, _ref6) {
	  var selectedLocation = _ref5.selectedLocation;
	  var selectedLength = _ref6.selectedLength;
	  return { selectedLocation: selectedLocation, selectedLength: selectedLength };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LengthSelector = LengthSelector;
	...
	function LengthSelector(_ref) {
	  var selectedLength = _ref.selectedLength;
	  var selectLength = _ref.selectLength;
	
	  return _react2.default.createElement(
	    'section',
	    { className: 'length-selector centered' },
	    _react2.default.createElement(
	      'h1',
	      null,
	      'Length'
	    ),
	    _react2.default.createElement(_torchRadioGroup.TorchRadioGroup, { options: _mission.LENGTHS, name: 'length', selectedValue: selectedLength, onChange: selectLength })
	  );
	}
	
	exports.default = (0, _reactRedux.connect)(_mission.getSelectedLength, { selectLength: _mission.selectLength })(LengthSelector);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MissionProvisions = MissionProvisions;
	...
	var _provisions = __webpack_require__(189);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
	
	var types = ['firewood', 'food', 'shovels', 'antivenoms', 'bandages', 'herbs', 'keys', 'holyWaters', 'torches'];
	
	function stacks(quantity, stackSize) {
	  var stacks = [];
	  var rest = quantity % stackSize;
	  for (var i = stackSize; i < quantity; i += stackSize) {
	...
	function renderProvisionStack(provision, quantity, index) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'provision-item', key: 'provision-' + provision.label + '-' + index },
	    _react2.default.createElement('img', { className: 'provision-icon', src: provision.icon(quantity), alt: provision.label }),
	    _react2.default.createElement(
	      'div',
	      { className: 'provision-quantity' },
	      quantity > 1 ? quantity : ''
	    )
	  );
	}
	...
	function renderProvisionStacks(provision) {
	  return stacks(provision.quantity, provision.stack).map(renderProvisionStack.bind(null, provision));
	}
	
	function MissionProvisions(_ref) {
	  var selectedLocation = _ref.selectedLocation;
	  var selectedLength = _ref.selectedLength;
	
	  var provisions = (0, _provisions.getMissionProvisions)(selectedLocation, selectedLength);
	
	  return _react2.default.createElement(
	    'section',
	    { className: 'level-provisions centered' },
	    _react2.default.createElement(
	      'h1',
	      null,
	      'Provisions'
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'provisions-list' },
	      types.reduce(function (rendered, type) {
	
	        var provision = provisions[type];
	
	        if (!provision.quantity) return rendered;
	
	        return [].concat(_toConsumableArray(rendered), _toConsumableArray(renderProvisionStacks(provision)));
	      }, [])
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'provisions-total' },
	      _react2.default.createElement(
	        'span',
	        { className: 'provisions-total-label' },
	        'Total Cost:'
	      ),
	      ' ',
	      _react2.default.createElement('img', { src: './icons/coin.png' }),
	      ' ',
	      _react2.default.createElement(
	        'span',
	        { className: 'provisions-total-amount' },
	        provisions.totalCost.toLocaleString()
	      )
	    )
	  );
	}
	
	exports.default = (0, _reactRedux.connect)(_mission.getSelectedLocationAndLength)(MissionProvisions);
...
/***/ function(module, exports) {
	...
	exports.getMissionProvisions = getMissionProvisions;
	...
	var iconPath = './icons/provisions/';
	
	var provisions = {
	  firewood: {
	    label: 'Firewood',
	    icon: function icon(_) {
	      return iconPath + 'Firewood.png';
	    },
	    cost: 0,
	    stack: 1
	  },
	  ...
	  herbs: {
	    ...
	    icon: function icon(_) {
	      return iconPath + 'Medicinal_Herbs.png';
	    },
	    cost: 200,
	    stack: 6
	  },
	  keys: {
	    label: 'Skeleton Keys',
	    icon: function icon(_) {
	      return iconPath + 'Skeleton_Key.png';
	    },
	    cost: 200,
	    stack: 6
	  },
	  holyWaters: {
	    label: 'Holy Waters',
	    icon: function icon(_) {
	      return iconPath + 'Holy_Water.png';
	    },
	    cost: 150,
	    stack: 6
	  },
	...
	var DATA = {
	  ruins: {
	    short: _extends({}, baseProvisions.short, {
	      herbs: 1,
	      holyWaters: 2,
	      bandages: 1,
	      antivenoms: 0,
	    ...
	    medium: _extends({}, baseProvisions.medium, {
	      herbs: 2,
	      holyWaters: 3,
	      bandages: 2,
	      antivenoms: 0,
	    ...
	    long: _extends({}, baseProvisions.long, {
	      herbs: 3,
	      holyWaters: 4,
	      bandages: 3,
	      antivenoms: 0,
	...
	function getMissionProvisions(location, length) {
	  var quantities = DATA[location][length];
	  return Object.keys(quantities).reduce(function (result, type) {
	    var quantity = quantities[type];
	    var subCost = provisions[type].cost * quantity;
	    return _extends({}, result, _defineProperty({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocationCurios = LocationCurios;
	...
	var _curios = __webpack_require__(191);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function renderOutcome(outcome, index) {
	  var amount = undefined;
	  var chances = undefined;
	  if (outcome.amount) {
	    amount = _react2.default.createElement(
	      'span',
	      { className: 'curio-outcome-amount' },
	      ' x',
	      outcome.amount
	    );
	  }
	  ...
	  if (outcome.chances !== 100) {
	    chances = _react2.default.createElement(
	      'span',
	      { className: 'curio-outcome-chances' },
	      outcome.chances,
	      '%'
	    );
	  }
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'curio-outcome', key: 'curio-outcome-' + index },
	    chances,
	    _react2.default.createElement(
	      'span',
	      { className: 'curio-outcome-label' },
	      outcome.type.label
	    ),
	    amount
	  );
	...
	function renderCurioOption(option, index) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'curio-cell curio-option', key: 'curio-option-' + index },
	    _react2.default.createElement(
	      'div',
	      { className: 'curio-cell-container' },
	      _react2.default.createElement(
	        'div',
	        { className: 'curio-cell-item' },
	        _react2.default.createElement('img', { className: 'curio-activator', src: option.activator.icon, alt: option.activator.label })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'curio-cell-item' },
	...
	function renderCurio(curio, index) {
	  ...
	  if (curio.icon) {
	    icon = _react2.default.createElement('img', { className: 'curio-icon', src: curio.icon, alt: curio.label });
	  }
	
	  return _react2.default.createElement(
	    'div',
	    { className: 'curio', key: 'curio-' + index },
	    _react2.default.createElement(
	      'div',
	      { className: 'curio-cell curio-description' },
	      _react2.default.createElement(
	        'div',
	        { className: 'curio-name' },
	        curio.name
	      ),
	      icon
	    ),
	...
	function LocationCurios(_ref) {
	  var selectedLocation = _ref.selectedLocation;
	
	  var curios = (0, _curios.getCuriosForLocation)(selectedLocation);
	
	  return _react2.default.createElement(
	    'section',
	    { className: 'level-curios' },
	    _react2.default.createElement(
	      'h1',
	      { className: 'centered' },
	      'Curios'
	...
	exports.default = (0, _reactRedux.connect)(_mission.getSelectedLocation)(LocationCurios);
...
/***/ function(module, exports) {
	...
	exports.getCuriosForLocation = getCuriosForLocation;
	
	function concatBuffEffects() {
	  var effects = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	
	  return effects.map(function effectToString(_ref) {
	    var type = _ref.type;
	...
	var outcomeTypes = {
	  ...
	  gainPositiveQuirk: function gainPositiveQuirk() {
	    var type = arguments.length <= 0 || arguments[0] === undefined ? 'random' : arguments[0];
	
	    return {
	      label: 'Gain ' + type + ' positive quirk'
	    };
	  },
	  gainNegativeQuirk: function gainNegativeQuirk() {
	    var type = arguments.length <= 0 || arguments[0] === undefined ? 'random' : arguments[0];
	  ...
	  addStress: function addStress(amount) {
	    return {
	      label: 'Stress +' + amount
	    };
	  },
	  removeStress: function removeStress(amount) {
	    return {
	      label: 'Stress heal ' + amount
	    };
	  },
	  setLight: function setLight(to) {
	    return {
	      label: 'Set light to ' + to
	    };
	  },
	  decreaseLight: function decreaseLight(by) {
	    return {
	  ...
	  buff: function buff(effects, untilCamp) {
	    return {
	      label: 'Buff ' + concatBuffEffects(effects) + (untilCamp ? ' until camp' : '')
	    };
	  },
	  debuff: function debuff(effects, untilCamp) {
	    return {
	      label: 'Debuff ' + concatBuffEffects(effects) + (untilCamp ? ' until camp' : '')
	    };
	  },
	  disease: function disease() {
	    var diseaseName = arguments.length <= 0 || arguments[0] === undefined ? 'random' : arguments[0];
	
	    return {
	      label: diseaseName + ' disease'
	    };
	  },
	  healStressEffectAndHP: function healStressEffectAndHP(stressHeal, hpHeal) {
	    return {
	  ...
	  buffDMGAndAccAndCRTAndCureStatusEffect: function buffDMGAndAccAndCRTAndCureStatusEffect(dmg, acc, crt) {
	    return {
	...
	var provisionsIconPath = './icons/provisions/';
	var activators = {
	  nothing: {
	    label: 'Nothing',
	...
	var curiosPerLocation = {
	  'ruins': [].concat(universalCurios, [{
	    name: 'Alchemy Table',
	  ...
	  'warrens': [].concat(universalCurios, [{
	    name: 'Bone Altar',
	...
	function getCuriosForLocation(location) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LocationTips = LocationTips;
	...
	var _tips = __webpack_require__(193);
	...
	function renderTip(tip, index) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'tips-list-item', key: index },
	    _react2.default.createElement(
	      'div',
	...
	function renderTipsCategory(category, tips) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'tips-category-item', key: 'category-' + category },
	    _react2.default.createElement(
	      'div',
	      { className: 'tips-cell' },
	      _react2.default.createElement(
	        'div',
	        { className: 'tips-category tips-category-' + category },
	        _react2.default.createElement(_capitalize2.default, { text: category })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'tips-list' },
	...
	var tipCategories = ['effective', 'ineffective', 'dangers'];
	
	function LocationTips(_ref) {
	  var selectedLocation = _ref.selectedLocation;
	
	  var tips = (0, _tips.getTipsForLocation)(selectedLocation);
	
	  return _react2.default.createElement(
	    'section',
	    { className: 'location-tips' },
	    _react2.default.createElement(
	      'h1',
	      { className: 'centered' },
	      'Tips'
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'tips-category-list' },
	      tipCategories.map(function (category) {
	        return renderTipsCategory(category, tips[category]);
	      })
	    )
	  );
	}
	
	exports.default = (0, _reactRedux.connect)(_mission.getSelectedLocation)(LocationTips);
...
/***/ function(module, exports) {
	...
	exports.getTipsForLocation = getTipsForLocation;
	var tips = {
	  ruins: {
	    effective: [{
	      label: 'Blight',
	...
	function getTipsForLocation(location) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxPersist = __webpack_require__(196);
	...
	function createNewStore() {
	  var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), (0, _reduxPersist.autoRehydrate)()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createAsyncLocalStorage = __webpack_require__(197);
	
	module.exports.persistStore = __webpack_require__(200);
	module.exports.autoRehydrate = __webpack_require__(210);
	module.exports.getStoredState = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noStorage = process && ({"NODE_ENV":"production"}) && ("production") === 'production' ? function () {
	  /* noop */return null;
	} : function () {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(198).setImmediate, (function() { return this; }()), __webpack_require__(199)))

/***/ },
/* 198 */
/***/ function(module, exports, __webpack_require__) {

	/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {var nextTick = __webpack_require__(199).nextTick;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashForeach = __webpack_require__(201);
	...
	var _defaultsAsyncLocalStorage = __webpack_require__(197);
	...
	function persistStore(store, config, onComplete) {
	  ...
	  function restoreKey(key, cb) {
	    storage.getItem(createStorageKey(key), function (err, serialized) {
	      if (err && ("production") !== 'production') console.warn('Error restoring data for key:', key, err);else rehydrate(key, serialized, cb);
	    });
	  }
	  ...
	  function rehydrate(key, serialized, cb) {
	    ...
	    try {
	      ...
	      if (false) console.warn('Error restoring data for key:', key, err);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bufferActions = __webpack_require__(216);
	  ...
	  function createRehydrationReducer(reducer) {
	    return function (state, action) {
	      if (action.type === _constants.REHYDRATE) {
	        ...
	        var statesArePlain = checkIfPlain(data, reducedState[key]);
	        if (!statesArePlain) {
	          // assign value
	...
	function getStoredState(config, onComplete) {
	  ...
	  storage.getAllKeys(function (err, allKeys) {
	    ...
	    _lodashForeach2['default'](persistKeys, function (key) {
	      storage.getItem(createStorageKey(key), function (err, serialized) {
	        if (err && ("production") !== 'production') console.warn('Error restoring data for key:', key, err);else restoredState[key] = rehydrate(key, serialized);
	        completionCount += 1;
